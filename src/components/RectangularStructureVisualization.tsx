      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-4">
          ...
          <div className="space-y-4">
            ...
            {/* Add Seismic Analysis Button */}
            <div className="mt-4">
              <a 
                href="/seismic-simulation" 
                className="w-full inline-flex justify-center items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
                onClick={(e) => {
                  e.preventDefault();
                  
                  // Create the building parameters object to pass to seismic simulation
                  const params = {
                    buildingParams: JSON.stringify(buildingParameters),
                    materialParams: JSON.stringify(selectedMaterial)
                  };
                  
                  // Convert to query string
                  const queryString = new URLSearchParams(params).toString();
                  
                  // Navigate to seismic simulation with parameters
                  window.location.href = `/seismic-simulation?${queryString}`;
                }}
              >
